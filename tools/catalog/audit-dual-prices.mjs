...
const cases = [
  ['1 550 $', '69 202 грн', '1 550 $'],
  ['4 917 грн', '4 917 грн', '110,13 $'],
  ['від 1 200–1 500 грн', 'від 1 200–1 500 грн', 'від 26,88–33,6 $'],
];
...
console.log(`OK: ${htmlFiles.length} HTML-сторінок, подвійні ціни та курс 44,6462 перевірено.`);
